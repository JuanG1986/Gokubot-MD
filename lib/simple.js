	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'Dragón ball bots', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363195436416919@newsletter", "120363195436416919@newsletter", "120363195436416919@newsletter", "120363195436416919@newsletter", "120363195436416919@newsletter"]
let canalNombre = ["Dragón ball bots", "Dragón ball bots", "Dragón ball bots", "Dragón ball bots", "Dragón ball bots"]
